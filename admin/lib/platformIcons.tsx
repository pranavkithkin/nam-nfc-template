...
export const PLATFORM_ICON_SVG: Record<string, string> = {
  ...
  twitter: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.259 5.632 5.905-5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>`,
  ...
  youtube: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>`,
  ...
  snapchat: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M12.166.006c.127-.007.253-.006.38-.006 1.64 0 7.045.45 9.243 6.162.59 1.527.433 4.132.318 5.944-.025.388-.05.758-.063 1.102.17.092.435.186.793.186.473 0 .985-.187 1.42-.662.195-.213.432-.312.666-.312.37 0 .733.24.844.606.168.567-.175 1.078-.78 1.455-.394.244-.944.453-1.657.607.103.21.152.437.17.663.057.716-.404 1.155-.93 1.297-.36.098-.69.055-.986-.06-.268-.105-.52-.16-.74-.16-.25 0-.453.065-.59.16-.64.453-1.05 1.66-1.378 2.677-.22.677-.46 1.077-.79 1.376-.507.455-1.122.612-1.802.718-.46.072-1.02.12-1.618.12-.34 0-.613-.015-.802-.025-.17.162-.423.487-.56.75-.23.438-.605.99-1.16 1.357-.738.489-1.596.571-2.524.571-.147 0-.29-.003-.43-.01-.15.008-.31.01-.46.01-.873 0-1.765-.082-2.524-.57-.554-.368-.93-.92-1.16-1.358-.135-.263-.39-.588-.56-.75-.186.01-.46.024-.8.024-.6 0-1.16-.048-1.62-.12-.68-.106-1.295-.263-1.803-.718-.33-.3-.568-.7-.79-1.376C2.59 17.61 2.18 16.403 1.54 15.95c-.137-.096-.34-.16-.59-.16-.22 0-.473.055-.74.16-.296.115-.626.158-.987.06-.525-.142-.987-.58-.93-1.297.018-.226.066-.453.17-.663-.714-.154-1.263-.363-1.657-.607-.605-.377-.948-.888-.78-1.455.11-.366.473-.606.844-.606.234 0 .47.1.666.312.435.475.947.662 1.42.662.358 0 .624-.094.793-.186-.013-.344-.037-.714-.063-1.102C-.387 6.608-.544 4.003.046 2.476 2.225.773 7.453.007 12.167.006z"/></svg>`,
  ...
  behance: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14H15.97c.13 3.211 3.483 3.312 4.588 2.029H23.72zm-7.726-3h3.543c-.141-1.547-1.438-1.658-1.943-1.658-.605 0-1.453.34-1.6 1.658zm-5 3c.557 1.708-1.107 3-4.131 3H0V5h5.399c3.06 0 5.063 1.229 4.958 3.885C10.284 10.092 9.52 10.979 8 11.441c1.563.44 2.512 1.57 2 2.559zM4 8v3h1.228c1.343 0 2.148-.529 2.148-1.533C7.376 8.454 6.594 8 5.328 8H4zm0 5v3h1.505c1.676 0 2.467-.598 2.467-1.555C7.972 13.562 7.13 13 5.505 13H4z"/></svg>`,

  github: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>`,

  dribbble: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.936-4.02 4.395-6.87zm-6.115 7.808c-.153-.9-.75-4.032-2.19-7.77l-.066.02c-5.79 2.015-7.86 6.025-8.04 6.4 1.73 1.358 3.92 2.166 6.29 2.166 1.42 0 2.77-.29 4-.814zm-11.62-2.logout c.232-.4 3.045-5.055 8.332-6.765.135-.045.27-.084.405-.12-.26-.585-.54-1.167-.832-1.74C7.17 11.775 2.206 11.71 1.756 11.7l-.004.312c0 2.633.998 5.037 2.634 6.838zm-2.42-8.955c.46.008 4.683.026 9.477-1.248-1.698-3.018-3.53-5.558-3.8-5.928-2.868 1.35-5.01 3.99-5.676 7.176zM9.6 2.052c.282.38 2.145 2.914 3.822 6 3.645-1.365 5.19-3.44 5.373-3.702-1.81-1.61-4.19-2.586-6.795-2.586-.825 0-1.63.1-2.4.288zm10.335 3.483c-.218.29-1.935 2.493-5.724 4.04.24.49.47.985.68 1.486.08.18.15.36.22.53 3.41-.43 6.8.26 7.14.33-.02-2.42-.88-4.64-2.31-6.386z"/></svg>`,

  pinterest: `<svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.373 0 0 5.373 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 0 1 .083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.632-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0z"/></svg>`,
...
export function PlatformIcon({ platform, size = 18 }: { platform: string; size?: number }) {
  const svg = PLATFORM_ICON_SVG[platform] || PLATFORM_ICON_SVG.website;
  const dataUri = `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(svg)}`;
  // eslint-disable-next-line @next/next/no-img-element
  return <img src={dataUri} alt={platform} width={size} height={size} style={{ display: "block", flexShrink: 0 }} />;
}
